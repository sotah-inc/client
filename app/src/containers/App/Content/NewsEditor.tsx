...
import { FetchUpdatePost } from "@app/actions/posts";
...
const mapStateToProps = (state: IStoreState): IStateProps => {
    ...
    const { currentPost, updatePostErrors, updatePostLevel } = state.Posts;

    return { currentPost, profile, updatePostErrors, updatePostLevel };
};
